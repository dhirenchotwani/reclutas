				...
				<div class="top-header">
					...
					<div class="top-header-author">
						...
						<div class="author-content">
							<a href="02-ProfilePage.html" class="h4 author-name"><?php echo $faculty_first_name." ".$faculty_last_name; ?></a>
							<div class="country"><?php echo $faculty_address_state; ?>, India</div>
						</div>
					</div>
				</div>
			</div>
					...
					<article class="hentry post">
							...
							<div class="post__author author vcard inline-items">
								...
								<div class="author-date">
									<a class="h6 post__author-name fn" href="02-ProfilePage.html"><?php echo $faculty_first_name." ".$faculty_last_name; ?></a>
				...
				<div class="ui-block">
					...
					<article class="hentry post video">
							...
							<div class="post__author author vcard inline-items">
								...
								<div class="author-date">
									<a class="h6 post__author-name fn" href="02-ProfilePage.html"><?php echo $faculty_first_name." ".$faculty_last_name; ?></a> shared a
									<a href="#">link</a>
									<div class="post__date">
										  <time class="published" datetime="<?php echo $post['created_at']; ?>">
                                                <?php $date=date('d M Y', strtotime($post['created_at'])); echo $date; ?> at
				...
				<div class="ui-block">
					...
					<article class="hentry post has-post-thumbnail shared-photo">
							...
							<div class="post__author author vcard inline-items">
								...
								<div class="author-date">
									<a class="h6 post__author-name fn" href="02-ProfilePage.html"><?php echo $faculty_first_name." ".$faculty_last_name; ?></a> shared
